...
namespace SangalTec.Bunsiness.Bunsiness
{
    public class ProveedorBusiness : IProveedorBusiness
    {
        ...
        {
            return await _context.Proveedores.Include(e => e.Insumos).ToListAsync();
        }
        ...
        public async Task<Proveedor> ObtenerProveedorPorId(int? id)
        {
            ...
            return await _context.Proveedores.Include(e => e.Insumos).FirstOrDefaultAsync(e => e.ProveedorId == id);
        }
